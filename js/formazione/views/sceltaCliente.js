...
// ============================================================
//  SCEGLI UN COMMITTENTE DALLA RUBRICA
  ...
  return new Promise((risolvi) => {
    ...
    const corpo = el(`<div>
      <div class="search" style="margin-bottom:12px">
        ...
        <input type="text" id="cerca" placeholder="Filtra per nome, partita IVA o referente…">
      </div>
    ...
    function disegna() {
      ...
      if (!righe.length) {
        zona.appendChild(el(`<p class="muted" style="text-align:center;padding:18px">
          ${elenco.length ? 'Nessuna azienda con questo nome.' : 'La rubrica è vuota: compila il destinatario e usa «Salva in rubrica».'}</p>`));
        return;
      }
