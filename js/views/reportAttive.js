...
export async function renderReportAttive(view, ctx) {
  ...
  const wrap = el(`<div>
    <div class="page-head">
      <div><h1>Report</h1><p>Riepilogo di incassi per cliente e nel tempo — Croce Rossa Italiana — Comitato di Genova</p></div>
      <div class="actions">
...
function giorniIncasso(f) {
  ...
  // Vedi il commento gemello in report.js: date malformate producono NaN,
  // da trattare come "non calcolabile" invece di propagarlo nelle medie.
