...
- **Impostazioni** — causali proposte e le due soglie di attenzione (ore al mese per dipendente, ore in una sola registrazione). Le modifica l'admin di sezione; gli altri le vedono in sola lettura.
